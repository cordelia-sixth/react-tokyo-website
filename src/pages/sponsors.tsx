          ...
          <div className="space-y-10 rounded-lg border-2 border-gray-400 p-8">
            <div className="space-y-5">
              <h4 className="ml-[-10px] flex items-center">
                <span className='h-[50px] w-[50px] shrink-0 bg-[#00dd34] [mask-image:url("/images/premium.svg")] [mask-position:center] [mask-repeat:no-repeat] [mask-size:cover]'></span>
            ...
            <div className="space-y-5">
              <h4 className="ml-[-9px] flex items-center gap-1.5">
                <span className='h-[45px] w-[45px] shrink-0 bg-[#00dd34] [mask-image:url("/images/handshake.svg")] [mask-position:center] [mask-repeat:no-repeat] [mask-size:cover]'></span>
            ...
            <div className="space-y-5">
              <h4 className="ml-[-9px] flex items-center gap-2">
                <span className='h-[45px] w-[45px] shrink-0 bg-[#00dd34] [mask-image:url("/images/heart.svg")] [mask-position:center] [mask-repeat:no-repeat] [mask-size:cover]'></span>
